...
__/opt__ dir only writable for root. so you should be: `sudo chown $(whoami) linux-remote`
...
If you don't want used `root` start up. You should be:  `sudo chown youname linux-remote`.
